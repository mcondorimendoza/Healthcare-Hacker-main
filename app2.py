...
tab1, tab2, tab3, tab4 = st.tabs(["Symptom Tracker", "Medical Image Analysis", "Reports & Visualizations", "Medical Chatbot"])
...
with tab3:
    ...
    with tab4:
        st.header("Lets Talk to Your medical assistant")
